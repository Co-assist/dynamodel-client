...
function mergeItemCollectionMetrics(responses, tableName) {
    return (0, objectUtils_1.flatArray)(responses.map((response) => { var _a; return (_a = response.ItemCollectionMetrics) === null || _a === void 0 ? void 0 : _a[tableName]; }).filter(objectUtils_1.isDefine));
}
...
function mergeBatchDeleteUnprocessedKeys(responses, tableName) {
    const writeRequestsList = (0, objectUtils_1.flatArray)(responses.map((response) => { var _a; return (_a = response.UnprocessedItems) === null || _a === void 0 ? void 0 : _a[tableName]; }).filter(objectUtils_1.isDefine));
...
function mergeBatchGetUnprocessedKeys(responses, tableName) {
    return (0, objectUtils_1.flatArray)(responses.map((response) => { var _a, _b; return (_b = (_a = response.UnprocessedKeys) === null || _a === void 0 ? void 0 : _a[tableName]) === null || _b === void 0 ? void 0 : _b.Keys; }).filter(objectUtils_1.isDefine));
}
