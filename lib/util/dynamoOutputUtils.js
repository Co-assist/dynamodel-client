...
function mergeBatchGetUnprocessedKeys(responses, tableName) {
    return objectUtils_1.flatArray(responses.map((response) => { var _a, _b; return (_b = (_a = response.UnprocessedKeys) === null || _a === void 0 ? void 0 : _a[tableName]) === null || _b === void 0 ? void 0 : _b.Keys; }).filter(objectUtils_1.isDefine));
}
