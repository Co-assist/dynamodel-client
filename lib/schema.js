...
class Schema {
    ...
    validatePath(object, path) {
        ...
        if ((attributeSchema === null || attributeSchema === void 0 ? void 0 : attributeSchema.test(object[attributeName], path, object)) !== true) {
...
class Schemaless extends Schema {
    ...
    getAttributeSchema(attributeName) {
        var _a;
        return (_a = super.getAttributeSchema(attributeName)) !== null && _a !== void 0 ? _a : Schemaless.ATTRIBUTE_SCHEMA;
    }
    /** @override */
    toJSON(object) {
...
function getSchema(object) {
    var _a;
    return object[exports.ModelSchemaSymbol] || ((_a = object.prototype) === null || _a === void 0 ? void 0 : _a[exports.ModelSchemaSymbol]);
}
