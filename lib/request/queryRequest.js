...
class QueryRequest {
    ...
    sendRequest(exclusiveStartKey, limit) {
        ...
        const command = new client_dynamodb_1.QueryCommand(awsParams);
    ...
    buildModelsFromResponses(responses) {
        const items = (0, objectUtils_1.flatArray)(responses.map((response) => { var _a; return (_a = response.Items) !== null && _a !== void 0 ? _a : []; }));
