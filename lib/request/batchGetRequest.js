...
class BatchGetRequest {
    ...
    sendRequest(keys) {
        ...
        const command = new client_dynamodb_1.BatchGetItemCommand(awsParams);
        return this.documentClient.send(command);
    }
    buildModelsFromResponses(responses, tableName) {
        const items = (0, objectUtils_1.flatArray)(responses.map((response) => { var _a, _b; return (_b = (_a = response.Responses) === null || _a === void 0 ? void 0 : _a[tableName]) !== null && _b !== void 0 ? _b : []; }));
