...
class BatchGetRequest {
    constructor(documentClient, params, stage) {
        ...
        this.keysList = objectUtils_1.splitArray(keys, exports.BATCH_GET_LIMIT);
    ...
    async execute() {
        ...
        const consumedCapacity = dynamoOutputUtils_1.mergeBatchGetConsumedCapacities(responses, tableName);
        const unprocessedKeys = dynamoOutputUtils_1.mergeBatchGetUnprocessedKeys(responses, tableName);
        return {
            consumedCapacity,
            models,
            responses,
    ...
    buildModelsFromResponses(responses, tableName) {
        const items = objectUtils_1.flatArray(responses.map((response) => { var _a, _b; return (_b = (_a = response.Responses) === null || _a === void 0 ? void 0 : _a[tableName]) !== null && _b !== void 0 ? _b : []; }));
